  ...
  let s:guishade0 = "#13222e"
  let s:guishade1 = "#293845"
  let s:guishade2 = "#3f4f5b"
  let s:guishade3 = "#556572"
  let s:guishade4 = "#6a7b88"
  let s:guishade5 = "#80919f"
  let s:guishade6 = "#96a8b5"
  let s:guishade7 = "#acbecc"
  let s:guiaccent0 = "#ca3e5a"
  let s:guiaccent1 = "#d8843e"
  let s:guiaccent2 = "#ebb062"
  let s:guiaccent3 = "#81a559"
  let s:guiaccent4 = "#42abab"
  let s:guiaccent5 = "#4496cd"
  let s:guiaccent6 = "#9770b2"
  let s:guiaccent7 = "#b35d8d"
  ...
  let s:ctermaccent0 = 168
  let s:ctermaccent1 = 6
  let s:ctermaccent2 = 216
